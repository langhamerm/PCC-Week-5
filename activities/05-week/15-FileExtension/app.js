...
function extensionSorter(fileArray) {
    for (var i = 0; i < fileArray.length; i++) {
        // Grab the file extension from the current file name
        // We do this by splitting the string into and array
        // Then we pop off the last item in the array which is file extension
